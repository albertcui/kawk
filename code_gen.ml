...
let print_unit_decl (u : Sast.unit_decl) = match u with
	Outer_udecl(str, udecl_params, udecl_check_val, true) -> print_string "if("; print_string (str.fname ^ "(");  print_expr_list_comma udecl_params; print_string ")==("; print_expr udecl_check_val; print_string ")) System.out.println(\"The test to call "; print_string (str.fname ^ "(");  print_expr_list_comma udecl_params; print_string ") passes\"); else System.out.println(\"The test to call "; print_string (str.fname ^ "(");  print_expr_list_comma udecl_params; print_string ") fails\"); \n"
	| Outer_udecl(str, udecl_params, udecl_check_val, false) -> print_string "if("; print_string (str.fname ^ "(");  print_expr_list_comma udecl_params; print_string ")==("; print_expr udecl_check_val; print_string ")) System.out.println(\"The test to call "; print_string (str.fname ^ "("); print_expr_list_comma udecl_params; print_string ") fails\"); else System.out.println(\"The test to call "; print_string (str.fname ^ "(");  print_expr_list_comma udecl_params; print_string ") passes\"); \n"
